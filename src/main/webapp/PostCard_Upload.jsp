            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card-header py-3">
                     ...
                     <%--  <h6 align="left"><a href="getPCards?categoryId=${categoryId}" >All Cards</a></h6> --%>
                    </div>
                    <div class="card-body">
                      <p>Upload Card.</p>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
		                     <form method="POST" action="uploadPostCard" enctype="multipart/form-data"> 
	                            ...
	                            <div class="pb-2">                            
	                            <input type="hidden" class="btn btn-primary btn-icon-split"  name="categoryId" value="${categoryId}">
				                </div>
	                            <div class="pb-2">			                
				                <select name="editable" style="width:100%;">
				                	<option >--Is Editable--</option>

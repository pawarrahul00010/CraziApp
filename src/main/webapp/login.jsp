...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    ...
    <!-- Outer Row -->
    <div class="row justify-content-center pad" style="padding:10% 0%;">
      ...
      <div class="col-xl-8 col-lg-8 col-md-8">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row" style="padding: 9% 2% 10% 25%">
                  ...
                  <form class="user" method="post" action="adminLogin">
                    ...
                    <div class="form-group">
                     ...
                     <div class="text-center mx-auto">
                   		<input type="submit" value="LOGIN" class="btn btn-facebook btn-user " style="padding:10px 46px" >
					</div>
                    </a>
                    <hr>
